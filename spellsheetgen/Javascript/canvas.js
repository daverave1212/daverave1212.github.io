	...
	/*var Constants = {
		...
		canvasHeight		: 1052,
		columnWidth			: 351,
		columnPaddingSide	: 12,
		columnPaddingTop	: 12,
		columnPaddingMiddle	: 6,
		iconBoxWidth		: 120,
		iconWidth			: 79,
		iconPaddingSide		: 19.2,
		iconPaddingTop		: 19.2,
		textBoxMaxWidth		: 339,
		textBoxPaddingTop 	: 9.6,
		font				: "15px IskoolaPota",
		lineHeight			: 15,
		backgroundColor		: "#FFFFFF",
		strokeColor			: "#444040",
		titleFont			: "18px IskoolaPota",
		canvasID			: "Canvas",
	...
	function Spell(Name, Type, CastingTime, Range, Components, Duration, Description, IconPath){
		...
		this.components = parseComponents(Components);		//removeFirstWord(Components);
	...
	function SpellBox(spell, x, y){
		...
		this.description = new TextBox(x, y + Constants.lineHeight * 5, Constants.textBoxMaxWidth - Constants.iconBoxWidth, Constants.font, Constants.getCanvas(), Constants.lineHeight);
